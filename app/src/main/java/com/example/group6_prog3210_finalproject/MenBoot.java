...
public class MenBoot extends AppCompatActivity {
    ...
    private void addToCart() {
        ...
        if (cbComp1.isChecked()) {
            ...
            Item item1 = new Item(1, "Chelsa Shoe", "Boys Casual Flat Shoes ", 25.99, 1);
        ...
        if (cbComp2.isChecked()) {
            ...
            Item item2 = new Item(2, "Chuka", "Boys's Marck fisher flat wear", 130.99, 2);
        ...
        if (cbComp3.isChecked()) {
            ...
            Item item3 = new Item(3, "Hiking", "Boys's Elegant Flat Shoes from Aldo", 324.99, 3);
