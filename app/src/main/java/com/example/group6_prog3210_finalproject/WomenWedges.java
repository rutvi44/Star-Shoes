...
public class WomenWedges extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_women_wedges);    cbComp1 = findViewById(R.id.checkbox_shoe1);
    ...
    private void addToCart() {
        ...
        if (cbComp1.isChecked()) {
            ...
            Item item1 = new Item(1, "Prada wedges", "women's prada", 125.99, 1);
        ...
        if (cbComp2.isChecked()) {
            ...
            Item item2 = new Item(2, "KNOKR wedges", "sweet expensive wedges", 130.99, 2);
        ...
        if (cbComp3.isChecked()) {
            ...
            Item item3 = new Item(3, "Aldo wedges", "Women's Elegant aldo wedges", 34.99, 3);
