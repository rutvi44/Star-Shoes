...
public class MenCasualShoes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mencasualshoes);
        // Initialize checkboxes and buttons
        cbComp1 = findViewById(R.id.cbAuto1);
        cbComp2 = findViewById(R.id.cbAuto2);
        cbComp3 = findViewById(R.id.cbAuto3);
    ...
    private void addToCart() {
        ...
        if (cbComp1.isChecked()) {
            ...
            Item item1 = new Item(1, "Sneakers Shoe", "Boys sneakers ", 225.99, 1);
        ...
        if (cbComp2.isChecked()) {
            ...
            Item item2 = new Item(2, "Boat", "Boys's Boat shoes", 10.99, 2);
        ...
        if (cbComp3.isChecked()) {
            ...
            Item item3 = new Item(3, "Sandels", "Boys's sndel", 32.99, 3);
