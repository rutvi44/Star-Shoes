...
public class MenCasualShoes extends AppCompatActivity {
    private CheckBox cbAuto1,cbAuto2,cbAuto3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cbAuto1=findViewById(R.id.cbAuto1);
        cbAuto2=findViewById(R.id.cbAuto2);
        cbAuto3=findViewById(R.id.cbAuto3);
...
//        });
    ...
    public void addToView(){
        ...
        boolean app1Checked = cbAuto1.isChecked();
        boolean app2Checked = cbAuto2.isChecked();
        boolean app3Checked = cbAuto3.isChecked();
